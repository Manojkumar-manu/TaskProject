...
const LightHouseImg = () => {
  return (
    <div className={styles.mainBlock}>
      <button className={styles.menuBlock}>
      ...
      <div className={styles.description}>
        ...
        <p>
          <i>
            Immerse yourself in the amazing atmosphere of <br /> Karelia ride in
      ...
      <main id={styles.block_section}>
        ...
        <div id={styles.second_div}>
          <h1>Relax Tours</h1>
          <p>
            Visit sarajevo and explore Bosnia and hercegovina <br /> with relax
        ...
        <div id={styles.third_div}>
          ...
          <p>
            Also called action sports,affro sports and adventurous <br /> sports
            is popular term for certain activities perceived
          </p>
        </div>
